...
if __name__ == '__main__':
    ...
    for env_index in range(len(env_list)):
        sr = test_env_simple(env_names[env_list[env_index]], tau0, env_index, high_level_net, sub_skills, args.k_shot, args.fine_tune_step)
        print('test_skill_num=', args.test_skill_num, ' suite=', args.test_suite, ' k_shot=', k_shot, ' env=', env_names[env_list[env_index]], ' finetune_step=', args.fine_tune_step, ' sr=', sr)
